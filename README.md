...
- Configurable keybinds provide item, category, and quantity sorting plus consolidate, transfer-matching, and safe-deposit actions while an inventory or container screen is open. Safe deposit keeps the hotbar, armour, favourite item IDs, and locked slots.
