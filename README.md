...
- At a normal crafting table, the vanilla recipe book and JEI/EMI recipe-fill actions can pull ingredients from eligible storage within a 16-block radius.
